...
> A full-stack URL shortener application featuring a sleek UI, click analytics, custom aliases, and rate limiting.
...
Edit `config/default.json` and provide your MongoDB connection string (`mongoURI`).
```json
{
